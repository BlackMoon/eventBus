/****************************/
/* Infragistics Metro theme */
/****************************/
/***************************/
/* JQuery Framework styles */
/***************************/
/*!
...
/**********************************/
/* END of JQuery Framework styles */
/**********************************/
/* jQuery UI CSS theme */
...
.ui-iggrid-table-mrl .ui-widget-content td {
    border: 1px solid rgba(153, 153, 153, 0.06) !important;
}
.ui-iggrid-table-mrl .ui-widget-content td.ui-state-hover,.ui-iggrid-table-mrl .ui-widget-content .ui-iggrid-altrecord td.ui-state-hover {
    border: 1px solid #b1b1b1 !important;
}
.ui-iggrid .ui-iggrid-headertable-mrl th,.ui-iggrid .ui-iggrid-table-mrl th {
    border: 2px solid #00aade !important;
}
...
.ui-widget-header.ui-state-default {
    ...
    color: white;
    font-weight: normal;
    text-shadow: 1px 0 rgba(83, 83, 83, 0.8);
}
...
.ui-widget-header.ui-state-active {
    ...
    color: white;
    font-weight: normal;
    text-shadow: 0 rgba(83, 83, 83, 0.8);
...
.ui-widget-header .ui-icon {
    background-image: url(images/ui-icons_858585_256x240.png);
}
...
/*  S.D. July 30th, 2015 ID203053 fixing info notification icon

.ui-icon-info {
    background: url(images/icon_sprite.png) 0px 0px no-repeat !important;
}
*/
.ui-icon-info
{
...
.ui-dialog.ui-igdialog.ui-widget-content {
    border: 2px solid #00AADE;
    color: #4B4B4B;
    padding: 0; /* overrides the default settings in the igDialog structure css*/
}
...
.ui-dialog .ui-dialog-titlebar-close.ui-state-focus.ui-state-focus,
...
.ui-datepicker th {
    ...
    /*important needed to override jquery's default padding */
}
...
.ui-iggrid th.ui-state-default {
    border-color: transparent transparent #00aade #e3e3e3;
}
...
.ui-iggrid th.ui-state-focus a {
    color: #4b4b4b;
    text-shadow: none, "";
}

.ui-iggrid thead th.ui-state-hover {
...
.ui-iggrid .ui-iggrid-editingcell .ui-iggrid-editor .ui-igedit-field {
    box-shadow: 0 3px 2px transparent inset;
}
...
.ui-iggrid-responsive-vertical tr.ui-ig-altrecord > td.ui-state-hover:first-child {
    color: #333333;
    border-color: #b7b7b7 transparent!important;
...
.ui-iggrid tr.ui-state-focus th {
    border-top-color: #00aade !important;
...
.ui-menu .ui-icon {
    /* background-image: url(images/igGrid/filter-icons-858585.png);*/
}
...
.ui-iggrid-groupbylabelrightedge.ui-state-default {
    /* Put your rules here */
}
...
.ui-iggrid-modaldialog-caption-buttoncontainer .ui-button.ui-state-hover {
    background: #2686ae none repeat-x;
    border: 1px solid #2788b1;
    -moz-box-shadow: none;
...
.ui-iggrid th .ui-iggrid-summaries-header-icon.ui-icon {
    background-image: url("../../structure/images/igGrid/filter-icons-333333.png") !important;
}
...
.ui-igplayer-full-screen-mode video:after {
    /* Put your rules here */
}
...
.ui-igplayer-full-screen-mode .ui-igplayer:before {
    ...
    background-image: -webkit-gradient(linear, 50% 0%, 50% 100%, color-stop(0%, #000000), color-stop(100%, #4c4c4c));
    background-image: -webkit-linear-gradient(#000000, #4c4c4c);
    background-image: -moz-linear-gradient(#000000, #4c4c4c);
    background-image: -o-linear-gradient(#000000, #4c4c4c);
    background-image: -ms-linear-gradient(#000000, #4c4c4c);
    background-image: linear-gradient(#000000, #4c4c4c);
    *zoom: 1;
    filter: progid: DXImageTransform.Microsoft.gradient(gradientType=0, startColorstr='#FF000000', endColorstr='#FF4C4C4C');
}
/* Autohide behavior */
...
.ui-igplayer .ui-igplayer-playbutton .ui-icon-pause {
    background-image: url(images/igVideoPlayer/igVideoPlayerIcons_858585.png);
    background-repeat: no-repeat;
    background-position: -23px -1px;
}
/* K.D. May 31st, 2011 Bug #77271 The play icon is overriden by jQuery themeswitcher */
...
.ui-igplayer .ui-igprogressbar-range {
    height: 2px;
    background-color: #00aade;
    background-image: -webkit-gradient(linear, 50% 0%, 50% 100%, color-stop(0%, #00aade), color-stop(100%, #00aade));
    background-image: -webkit-linear-gradient(#00aade, #00aade);
    background-image: -moz-linear-gradient(#00aade, #00aade);
    background-image: -o-linear-gradient(#00aade, #00aade);
    background-image: -ms-linear-gradient(#00aade, #00aade);
    background-image: linear-gradient(#00aade, #00aade);
    *zoom: 1;
    filter: progid: DXImageTransform.Microsoft.gradient(gradientType=0, startColorstr='#FF00AADE', endColorstr='#FF00AADE');
    border: 1px none;
}
...
.ui-igplayer.ui-igplayer-active video {
    /* Put your rules here */
}
/****************************************/
/***** These should be removed once *****/
/***** the igButton is fixed        *****/
/****************************************/

.ui-igvideoplayerbutton {
    /* Put your rules here */
}
...
/* Custom tooltip for bookmarks used on igVideoPlayer */
...
.ui-igslider .ui-igslider-bookmark-tooltip .ui-widget-content {
    ...
    background-image: none;
    color: white;
    background-image: -webkit-gradient(linear, 50% 0%, 50% 100%, color-stop(0%, #3bb7eb), color-stop(100%, #2686ae));
    background-image: -webkit-linear-gradient(#3bb7eb, #2686ae);
    background-image: -moz-linear-gradient(#3bb7eb, #2686ae);
    background-image: -o-linear-gradient(#3bb7eb, #2686ae);
    background-image: -ms-linear-gradient(#3bb7eb, #2686ae);
    background-image: linear-gradient(#3bb7eb, #2686ae);
    *zoom: 1;
    filter: progid: DXImageTransform.Microsoft.gradient(gradientType=0, startColorstr='#FF3BB7EB', endColorstr='#FF2686AE');
}

.ui-igslider .ui-igslider-bookmark-tooltip .ui-igtooltip-arrow-bottom {
    background-color: transparent;
    background-image: url(images/igVideoPlayer/igVPBookmarkSprite.png);
    background-repeat: repeat-x;
...
.ui-igprogressbar {
    ...
    *zoom: 1;
    filter: progid: DXImageTransform.Microsoft.gradient(gradientType=0, startColorstr='#FFD1D1D1', endColorstr='#FFD1D1D1');
}
...
*  igupload  *
******************/
/*.ui-iguploadmultiple .ui-igupload-container.ui-widget-content { border-color: #2884ac }*/
...
.ui-igupload-cancel-button.ui-state-focus .ui-icon-closethick {
    background-image: url(images/ui-icons_00AADE_256x240.png);
}
...
.ui-igcheckbox-small.ui-corner-all,
.ui-igcheckbox-normal.ui-corner-all,
.ui-igcombo-checkbox.ui-corner-all {
    border-radius: 2px;
}
...
.ui-ightmleditor-content textarea {
    border: 1px solid #cdcdcd;
    -moz-box-shadow: inset 2px 2px 3px rgba rgba(0, 0, 0, 0.1);
    -webkit-box-shadow: inset 2px 2px 3px rgba rgba(0, 0, 0, 0.1);
    -o-box-shadow: inset 2px 2px 3px rgba rgba(0, 0, 0, 0.1);
    box-shadow: inset 2px 2px 3px rgba rgba(0, 0, 0, 0.1);
}
/*breadcrumb styling*/
...
input.ui-button.ui-state-active {
    color: #ffffff;
    border-width: 2px;
}

input.ui-button.ui-state-focus {
...
button.ui-button.ui-state-hover.ui-state-focus,
a.ui-button.ui-state-hover.ui-state-focus {
    background-color: #EAEAEA;
}

button.ui-button.ui-state-hover.ui-state-active.ui-state-focus,
a.ui-button.ui-state-hover.ui-state-active.ui-state-focus {
    background-color: #00AADE;
}

.ui-button-icon-only.ui-state-focus .ui-button-text,
.ui-button-icons-only.ui-state-focus .ui-button-text {
    padding: 2px 4px 4px !important;
}

.ui-button-text-icon-primary.ui-state-active .ui-button-text {
    padding: 2px 11px 4px 24px !important;
}

.ui-button-text-icon-secondary.ui-state-active .ui-button-text {
    padding: 2px 24px 4px 11px;
}

.ui-button-text-icons.ui-state-active .ui-button-text {
...
.ui-igedit-dropdown .ui-igedit-listitem.ui-igedit-listitemselected.ui-state-highlight {
    color: #fff;
}
...
.ui-iggrid .ui-iggrid-headercaption.ui-widget-header {
    border-color: transparent;
    background-color: #00AADE;
    color: white;
}
...
.ui-iggrid table th:first-child {
    border-left-color: transparent;
}

.ui-iggrid thead th.ui-state-hover,
.ui-iggrid thead th.ui-state-hover:first-child {
    border-color: #858585 #858585 #00AADE #858585;
}
...
.ui-iggrid .ui-iggrid-header.ui-iggrid-sortableheaderfocus.ui-state-focus .ui-iggrid-headertext {
    color: #4B4B4B;
}

.ui-iggrid .ui-iggrid-header.ui-iggrid-sortableheaderfocus.ui-state-focus .ui-icon {
    background-image: url(images/ui-icons_858585_256x240.png);
}
...
/* Bug 213600, S.D. 25.02.2016, Selected row's last column cell text is overlapped by vertical scrollbar when using Metro theme
.ui-iggrid td.ui-state-hover {
...
.ui-iggrid .ui-iggrid-results input {
    line-height: 1.2em !important;
}

.ui-iggrid-paging > .ui-iggrid-pagedropdowncontainer {
    margin-top: 0.3em;
}

.ui-igedit-listitem.ui-state-highlight {
...
.ui-iggrid .ui-iggrid-footer .ui-iggrid-firstpage,
.ui-iggrid .ui-iggrid-footer .ui-iggrid-prevpage,
.ui-iggrid .ui-iggrid-footer .ui-iggrid-nextpage,
.ui-iggrid .ui-iggrid-footer .ui-iggrid-lastpage {
    border-color: #00AADE;
    background-color: #00AADE;
    color: white;
}
...
.ui-iggrid-results .ui-iggrid-pagesizelabel,
.ui-iggrid-results .ui-iggrid-pagesizelabel,
.ui-iggrid-pagedropdowncontainer .ui-iggrid-pagedropdownlabels {
    margin-top: 0.15em;
}

.ui-iggrid .ui-iggrid-paging .ui-iggrid-page.ui-state-default {
    background-color: transparent;
    border: 1px solid transparent;
    padding: 5px 12px;
}

.ui-iggrid .ui-iggrid-paging .ui-iggrid-pagecurrent.ui-state-active {
    border: 1px solid #FFFFFF;
    padding: 5px 12px;
}

.ui-iggrid .ui-iggrid-footer.ui-iggrid-pager .ui-iggrid-pagelink {
    color: #ffffff;
...
.ui-iggrid .ui-iggrid-footer.ui-iggrid-pager .ui-state-hover .ui-iggrid-pagelink,
.ui-iggrid .ui-iggrid-footer.ui-iggrid-pager .ui-state-hover .ui-iggrid-pagelinkcurrent,
.ui-iggrid-pagecurrent.ui-state-active.ui-state-hover a,
.ui-iggrid-pagecurrent.ui-iggrid-page-hover a {
    color: #ffffff;
...
.ui-iggrid-paging .ui-iggrid-page.ui-iggrid-page-hover {
    background-color: #EAEAEA;
    border: 1px solid #B7B7B7;
}

.ui-iggrid .ui-igedit-button.ui-state-hover {
    background-color: #EAEAEA;
}

.ui-iggrid .ui-igedit-button.ui-state-hover .ui-icon-triangle-1-s {
    background-image: url(images/ui-icons_565656_256x240.png);
}

.ui-iggrid .ui-iggrid-filterbutton,
.ui-iggrid-filterddlist .ui-iggrid-filtericon {
    background-image: url(images/igGrid/filter-icons-858585.png) !important;
}
...
/*Reset button on hide column dialog on grids */

.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton {
    font-size: 1.3em;
}

.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton.ui-state-default {
    border-color: #fff;
    background-color: transparent;
}

.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton.ui-state-default .ui-button-text {
    color: white;
}

.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton.ui-state-hover {
    border-color: #858585;
    background-color: #E5E5E5;
}

.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton.ui-state-hover .ui-button-text {
    color: #000;
}

.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton.ui-state-focus,
.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton.ui-state-active {
    border-color: #80D5EF;
    border-width: 1px;
}

.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton.ui-state-focus .ui-button-text,
.ui-iggrid-modaldialog-caption-buttoncontainer .ui-igbutton.ui-state-active .ui-button-text {
    color: white;
}
/*Rating*/

.ui-igrating .ui-igrating-selected.ui-state-highlight {
    padding: 0!important;
}
/* Touch friendly */
...
.ui-igplayer-tooltip .ui-widget-content {
    background: none;
    box-shadow: 0 0 19px 2px rgba(0, 0, 0, 0.2) !important;
}
...
.ui-igplayer .ui-igplayer-volumecontrol.ui-state-active .ui-icon,
.ui-igplayer .ui-igplayer-fullscreen-button.ui-state-active .ui-icon,
.ui-igplayer .ui-igplayer-playbutton.ui-state-active .ui-icon,
.ui-igplayer .ui-igplayer-related-video-replay.ui-state-active .ui-icon {
    background-image: url(images/igVideoPlayer/igVideoPlayerIcons_FFFFFF.png);
}
...
.ui-igplayer .ui-igplayer-bookmark-list {
    border-top-color: #00AADE;
}
...
.ui-igedit.ui-state-active .ui-igedit-cleararea .ui-icon  {
 ...
 .ui-igcombo-clear.ui-state-hover .ui-icon,
...
.ui-igcombo-button.ui-igcombo-button-pressed .ui-igcombo-buttonicon {
    background-image: url(images/ui-icons_00AADE_256x240.png) !important;
}
...
.ui-igcombo-field,
ui-igcombo-fieldholder,
.ui-igcombo-fieldholder-ltr {
    box-shadow: 0px 3px 2px, rgba(100, 100, 100, 0.1), inset;
}
/* IE 10 input fix */
...
.ui-igtree li a.ui-state-focus {
    color: #666;
}

.ui-igtree-node.ui-igtree-parentnode .ui-icon {
    background-image: url(images/ui-icons_858585_256x240.png);
}

.ui-igtree-checkbox .ui-icon,
.ui-igtree .ui-igcheckbox-normal .ui-icon,
.ui-igtree .ui-igcheckbox-small .ui-icon {
    background-image: url(images/ui-icons_00AADE_256x240.png);
}
/***********************
	Editors
...
.ui-igsplitter-collapse-button-vertical-right.ui-state-default,
.ui-igsplitter-collapse-button-horizontal-left.ui-state-default,
.ui-igsplitter-collapse-button-horizontal-right.ui-state-default {
...
.ui-igtreegrid-contextrow-icon.ui-icon.ui-icon-bookmark {
    background-image: url(../../structure/images/igGrid/filter-icons-333333.png);
